...
void main() {
  ...
  group('Library Search Integration Tests', () {
    testWidgets('Search functionality works correctly', (WidgetTester tester) async {
      ...
      if (searchField.evaluate().isNotEmpty) {
        ...
        expect(
          ...
          isTrue,
          reason: 'Search should display results or indicate search completion'
        );
      }
    });

    testWidgets('Empty search handling works correctly', (WidgetTester tester) async {
      // Start the app
      app.main();
      await tester.pumpAndSettle();
      ...
      if (discoverTab.evaluate().isNotEmpty) {
        ...
        if (searchField.evaluate().isNotEmpty) {
          ...
          if (searchButton.evaluate().isNotEmpty) {
            ...
            expect(
              errorMessage.evaluate().isNotEmpty || emptyMessage.evaluate().isNotEmpty,
              isTrue,
    ...
    testWidgets('Book details navigation works correctly', (WidgetTester tester) async {
      // Start the app
      app.main();
      await tester.pumpAndSettle();
      ...
      if (libraryTab.evaluate().isNotEmpty) {
        ...
        if (bookCards.evaluate().isNotEmpty) {
          ...
          // Verify navigation
          expect(find.byType(AppBar), findsOneWidget, reason: 'Should show details screen with app bar');
        }
      }
    });
  });
