...
class BookLocalDataSourceImpl implements BookLocalDataSource {
  ...
  Future<List<BookModel>> getBooks({
    ...
    try {
      ...
      String query = 'SELECT DISTINCT b.* FROM ${StorageConstants.tableBooks} b';
  ...
  Future<int> getBooksCount({
    ...
    try {
      ...
      String query = 'SELECT COUNT(DISTINCT b.id) as count FROM ${StorageConstants.tableBooks} b';
      List<String> whereConditions = [];
      List<Object> whereArgs = [];
  ...
  Future<CategoryModel> getCategoryById(String id) async {
    try {
      ...
      if (maps.isEmpty) {
        throw app_exceptions.NotFoundException('Category not found with id: $id');
      }

      return CategoryModel.fromMap(maps.first);
    } catch (e) {
      if (e is app_exceptions.NotFoundException) rethrow;
      throw app_exceptions.DatabaseException('Failed to get category: ${e.toString()}');
    }
  }
  ...
  Future<List<CategoryModel>> getCategories({String? parentId, bool includeChildCategories = true}) async {
    try {
      ...
      throw app_exceptions.DatabaseException('Failed to get categories: ${e.toString()}');
    }
  }
  ...
  Future<CategoryModel> insertCategory(CategoryModel category) async {
    try {
      ...
      final existing = await db.query(
        StorageConstants.tableCategories,
        where: 'name = ? AND parent_id ${category.parentId != null ? '= ?' : 'IS NULL'}',
        whereArgs: category.parentId != null ? [category.name, category.parentId] : [category.name],
        limit: 1,
      );
      
      if (existing.isNotEmpty) {
        throw app_exceptions.DatabaseException('Category with name "${category.name}" already exists');
      }
      ...
      throw app_exceptions.DatabaseException('Failed to insert category: ${e.toString()}');
    }
  }
  ...
  Future<CategoryModel> updateCategory(CategoryModel category) async {
    try {
      ...
      if (count == 0) {
        throw app_exceptions.NotFoundException('Category not found with id: ${category.id}');
      }

      return category;
    } catch (e) {
      if (e is app_exceptions.NotFoundException) rethrow;
      throw app_exceptions.DatabaseException('Failed to update category: ${e.toString()}');
    }
  }
  ...
  Future<void> deleteCategory(String id) async {
    try {
      ...
      if (children.isNotEmpty) {
        throw app_exceptions.DatabaseException('Cannot delete category with child categories');
      }
      ...
      if (e is app_exceptions.NotFoundException || e is app_exceptions.DatabaseException) rethrow;
      throw app_exceptions.DatabaseException('Failed to delete category: ${e.toString()}');
    }
  }
  ...
  Future<List<BookModel>> getBooksByCategory(String categoryId, {int? limit, int? offset, bool includeSubcategories = false}) async {
    try {
      ...
      throw app_exceptions.DatabaseException('Failed to get books by category: ${e.toString()}');
    }
  }
  ...
  Future<List<CategoryModel>> searchCategories(String query) async {
    try {
      ...
      throw app_exceptions.DatabaseException('Failed to search categories: ${e.toString()}');
    }
  }
  ...
  Future<Collection> getCollectionById(String id) async {
    try {
      ...
      if (maps.isEmpty) {
        throw app_exceptions.NotFoundException('Collection not found with id: $id');
      }
      ...
      if (e is app_exceptions.NotFoundException) rethrow;
      throw app_exceptions.DatabaseException('Failed to get collection: ${e.toString()}');
    }
  }
  ...
  Future<List<Collection>> getCollections({int? limit, int? offset, bool publicOnly = false}) async {
    try {
      ...
      throw app_exceptions.DatabaseException('Failed to get collections: ${e.toString()}');
    }
  }
  ...
  Future<Collection> insertCollection(Collection collection) async {
    try {
      ...
      final existing = await db.query(
        ...
        where: 'name = ? AND user_id ${collection.userId != null ? '= ?' : 'IS NULL'}',
        whereArgs: collection.userId != null ? [collection.name, collection.userId] : [collection.name],
        limit: 1,
      );
      
      if (existing.isNotEmpty) {
        throw app_exceptions.DatabaseException('Collection with name "${collection.name}" already exists');
      }
      ...
      if (e is app_exceptions.DatabaseException) rethrow;
      throw app_exceptions.DatabaseException('Failed to insert collection: ${e.toString()}');
    }
  }
  ...
  Future<Collection> updateCollection(Collection collection) async {
    try {
      ...
      if (count == 0) {
        throw app_exceptions.NotFoundException('Collection not found with id: ${collection.id}');
      }

      return collection;
    } catch (e) {
      if (e is app_exceptions.NotFoundException) rethrow;
      throw app_exceptions.DatabaseException('Failed to update collection: ${e.toString()}');
    }
  }
  ...
  Future<void> deleteCollection(String id) async {
    try {
      ...
      if (e is app_exceptions.NotFoundException) rethrow;
      throw app_exceptions.DatabaseException('Failed to delete collection: ${e.toString()}');
    }
  }
  ...
  Future<void> addBookToCollection(String collectionId, String bookId) async {
    try {
      ...
      if (collectionExists.isEmpty) {
        throw app_exceptions.NotFoundException('Collection not found with id: $collectionId');
      }
      ...
      if (bookExists.isEmpty) {
        throw app_exceptions.NotFoundException('Book not found with id: $bookId');
      }
      ...
      if (e is app_exceptions.NotFoundException) rethrow;
      throw app_exceptions.DatabaseException('Failed to add book to collection: ${e.toString()}');
    }
  }
  ...
  Future<void> removeBookFromCollection(String collectionId, String bookId) async {
    try {
      ...
      throw app_exceptions.DatabaseException('Failed to remove book from collection: ${e.toString()}');
    }
  }
  ...
  Future<List<BookModel>> getBooksInCollection(String collectionId, {int? limit, int? offset}) async {
    try {
      ...
      throw app_exceptions.DatabaseException('Failed to get books in collection: ${e.toString()}');
    }
  }
  ...
  Future<void> addBookCategory(String bookId, String categoryId) async {
    try {
      ...
      if (categoryExists.isEmpty) {
        throw app_exceptions.NotFoundException('Category not found with id: $categoryId');
      }
      ...
      if (e is app_exceptions.NotFoundException) rethrow;
      throw app_exceptions.DatabaseException('Failed to add book category: ${e.toString()}');
    }
  }
  ...
  Future<void> removeBookCategory(String bookId, String categoryId) async {
    try {
      ...
      throw app_exceptions.DatabaseException('Failed to remove book category: ${e.toString()}');
    }
  }
  ...
  Future<List<CategoryModel>> getBookCategories(String bookId) async {
    try {
      ...
      throw app_exceptions.DatabaseException('Failed to get book categories: ${e.toString()}');
    }
  }
  ...
  Future<List<BookModel>> getBooksByFilters({
    ...
    try {
      ...
      throw app_exceptions.DatabaseException('Failed to filter books: ${e.toString()}');
    }
  }

  /// Find potential duplicate books based on title and author similarity
  Future<List<List<BookModel>>> findDuplicateBooks({double similarityThreshold = 0.8}) async {
    try {
      final db = await _databaseConfig.database;
      ...
      List<BookModel> books = maps.map((map) {
        ...
        bookMap.remove('author_names'); // Remove the concatenated author names for BookModel creation
      ...
      for (int i = 0; i < books.length; i++) {
        ...
        for (int j = i + 1; j < books.length; j++) {
          ...
          if (_areBooksLikelyDuplicates(books[i], books[j], maps[i]['author_names'] as String?, maps[j]['author_names'] as String?)) {
      ...
      throw app_exceptions.DatabaseException('Failed to find duplicate books: ${e.toString()}');
    }
  }

  /// Helper method to determine if two books are likely duplicates
  bool _areBooksLikelyDuplicates(BookModel book1, BookModel book2, String? authors1, String? authors2) {
    ...
    if (authors1 != null && authors2 != null) {
      List<String> authorList1 = authors1.split(';').map((a) => a.trim().toLowerCase()).toList();
      List<String> authorList2 = authors2.split(';').map((a) => a.trim().toLowerCase()).toList();
      
      bool hasCommonAuthor = authorList1.any((author1) => 
        authorList2.any((author2) => _calculateStringSimilarity(author1, author2) > 0.8));
    ...
    if (book1.publicationDate != null && book2.publicationDate != null) {
      ...
      if (year1 > 0 && year2 > 0 && (year1 - year2).abs() > 2) return false; // Different editions should be within 2 years
    }
  ...
  Future<Map<String, dynamic>> exportLibraryData({
    ...
    try {
      ...
      if (includeCollections) {
        final collectionMaps = await db.query(StorageConstants.tableCollections);
      ...
      throw app_exceptions.DatabaseException('Failed to export library data: ${e.toString()}');
    }
  }

  /// Import library data from JSON
  Future<void> importLibraryData(Map<String, dynamic> data, {bool replaceExisting = false}) async {
    try {
      final db = await _databaseConfig.database;
      ...
      await db.transaction((txn) async {
        ...
        if (data['books'] != null) {
          for (Map<String, dynamic> bookMap in data['books']) {
            await txn.insert(
              StorageConstants.tableBooks,
              bookMap,
              conflictAlgorithm: replaceExisting ? ConflictAlgorithm.replace : ConflictAlgorithm.ignore,
            );
          }
        }
        ...
        if (data['relationships'] != null) {
          ...
          if (relationships['book_categories'] != null) {
            for (Map<String, dynamic> relMap in relationships['book_categories']) {
              await txn.insert(
                'book_categories',
                relMap,
                conflictAlgorithm: ConflictAlgorithm.ignore,
          ...
          if (relationships['collection_books'] != null) {
            for (Map<String, dynamic> relMap in relationships['collection_books']) {
              await txn.insert(
                'collection_books',
                relMap,
                conflictAlgorithm: ConflictAlgorithm.ignore,
      ...
      throw app_exceptions.DatabaseException('Failed to import library data: ${e.toString()}');
    }
  }
}
