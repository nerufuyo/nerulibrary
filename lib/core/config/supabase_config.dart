...
class SupabaseConfig {
  ...
  Future<AuthResponse> signUp({
    ...
    if (!AppConfig.instance.enableCloudSync) {
      throw const app_exceptions.AuthException(
          'Cloud sync is disabled. Cannot sign up.');
    }
  ...
  Future<AuthResponse> signIn({
    ...
    if (!AppConfig.instance.enableCloudSync) {
      throw const app_exceptions.AuthException(
          'Cloud sync is disabled. Cannot sign in.');
    }
  ...
  Future<void> resetPassword(String email) async {
    if (!AppConfig.instance.enableCloudSync) {
      throw const app_exceptions.AuthException(
          'Cloud sync is disabled. Cannot reset password.');
    }
  ...
  Future<UserResponse> updateProfile({
    ...
    if (!AppConfig.instance.enableCloudSync) {
      throw const app_exceptions.AuthException(
          'Cloud sync is disabled. Cannot update profile.');
    }
  ...
  SupabaseClient get database {
    if (!AppConfig.instance.enableCloudSync) {
      throw const app_exceptions.AuthException(
          'Cloud sync is disabled. Database not available.');
    }
    return _client!;
  }
  ...
  SupabaseStorageClient get storage {
    if (!AppConfig.instance.enableCloudSync) {
      throw const app_exceptions.AuthException(
          'Cloud sync is disabled. Storage not available.');
    }
  ...
  RealtimeClient get realtime {
    if (!AppConfig.instance.enableCloudSync) {
      throw const app_exceptions.AuthException(
          'Cloud sync is disabled. Realtime not available.');
    }
