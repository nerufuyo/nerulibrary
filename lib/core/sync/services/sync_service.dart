...
abstract class SyncService {
  ...
  /// Returns [SyncSession] on success or [SyncFailure] on error.
  Future<Either<SyncFailure, SyncSession>> startIncrementalSync(
...
abstract class EntitySyncService<T extends Syncable> {
  ...
  Future<Either<SyncFailure, List<T>>> pullChangesFromCloud(
      DateTime lastSyncTime);
  ...
  T? resolveConflictAutomatically(
      SyncConflict conflict, ConflictResolution strategy);
