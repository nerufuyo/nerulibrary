...
void main() {
  ...
  try {
    print(
        '   ✅ Project Gutenberg data source: lib/features/discovery/data/datasources/project_gutenberg_data_source.dart');
    print(
        '   ✅ Internet Archive data source: lib/features/discovery/data/datasources/internet_archive_data_source.dart');
    print(
        '   ✅ OpenLibrary data source: lib/features/discovery/data/datasources/openlibrary_data_source.dart');
    print(
        '   ✅ Project Gutenberg repository: lib/features/discovery/data/repositories/project_gutenberg_repository_impl.dart');
    print(
        '   ✅ Internet Archive repository: lib/features/discovery/data/repositories/internet_archive_repository_impl.dart');
    print(
        '   ✅ OpenLibrary repository: lib/features/discovery/data/repositories/openlibrary_repository_impl.dart');
    passedTests++;
  } catch (e) {
  ...
  try {
    ...
    print(
        '      - CacheableRepository mixin for Internet Archive and OpenLibrary');
